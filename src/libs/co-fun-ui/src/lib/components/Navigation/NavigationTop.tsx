  ...
  return (
    <Flex justifyContent='space-between' alignItems='center' top={["0", "unset"]} right={["0", "unset"]} position={["fixed", "unset"]} direction={["row", "row"]} p={['.5rem', '1.5rem 1.8rem']} boxShadow='0 3px 2px -2px rgba(32, 33, 36, 0.1)' zIndex={1} width={["100%"]}>
      <Box display={["flex", "inline-block"]} margin={["auto", "unset"]} pl={["36px", ".7rem"]}>
        <a href="https://cofun.digital" style={{ display: 'flex', alignItems: 'baseline' }}><Logo margin="auto" pl={["36px", "unset"]} height={["15px", "17px"]} /> <TextBase textStyle="activity-title" fontSize={['12pt', '14pt']} color="button.action" pt={["1rem", ".5rem"]} pb=".7rem" pl=".5rem" textAlign="center" mt={["3rem", "0"]}>featuring</TextBase></a>
      </Box>
