...
export default function Index() {
  return (
    <>
      <Head>
        <title>AI Role in Situational Leadership</title>
      </Head>
      <TextBase textStyle="heading" lineHeight="2" alignSelf="center">
        AI Role in Situational Leadership
      </TextBase>
      <TextBase textStyle="initiative-descr" lineHeight="2">
        At any point of your career you are going to ask the following questions: do I have the right people for this project?      </TextBase>
      <TextBase textStyle="project-descr" lineHeight="2" p=".5rem 0">
        The self-evaluation is more revealing than the question itself. A good team is the one that can critically judge its own capabilities. the real strength lies in difference, not in similarities, so how well do you know your team?      </TextBase>
      <TextBase textStyle="project-descr" lineHeight="2" p=".5rem 0">
